...
- Check the corresponding [Instructor's guide](https://github.ibm.com/skol/agentic-ai-client-bootcamp-instructors/tree/main/usecase-setup/manufacturing) repo to set up all environments and backend services.
...
- Ensure you have provided an updated OpenAPI Spec located in the instructor repo at `usecase-setup/manufacturing/openapi_spec_files/opeanapi_spec.json` with the correct URL to your deployed backend service for the lab participants.
...
### Tool Configuration:
- `openapispec.json`: External tool specification for log data retrieval, provided by instructor
