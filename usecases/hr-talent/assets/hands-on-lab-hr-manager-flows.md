...
```
![Add Tool](../assets/images/i15.png)
...
Next we will add another variable, select **Edit Details**

![Add Variable](../assets/images/i28.png)

Select **Add input**, then **String**

![Add Variable](../assets/images/i29.png)
...
![Add Variable](../assets/images/i30.png)
...
![Add Variable](../assets/images/i31.png)
...
![Add Variable](../assets/images/i32.png)

Select the **Add** button between Start and End

![Add Variable](../assets/images/i33.png)

Select **Collect from user** and **Number** from the options

![Add Variable](../assets/images/i34.png)
...
![Add Variable](../assets/images/i45.png)

Hover over the inside of the **User activity**, click on **+**, select **Display to user**, then **Message**:
...
![Add Variable](../assets/images/i47.png)
...
![Add Variable](../assets/images/i50.png)

Select **Display to user** then **Message**: 

![Add Variable](../assets/images/i51.png)
...
![Add Variable](../assets/images/i52.png)
![Add Variable](../assets/images/i53.png)
...
Then select the **Document extractor** node, rename it **Extract job skills**

![Add Variable](../assets/images/i55.png)
...
![User Activity 6](../assets/images/i73.png)

![User Activity 6](../assets/images/i74.png)
